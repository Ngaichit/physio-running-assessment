...
import { Users, PanelLeft, LogOut, Ruler, Zap, UserCog } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Ruler, label: "Metrics Standards", path: "/metrics" },
  { icon: UserCog, label: "Practitioners", path: "/practitioners" },
];
      ...
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-[oklch(0.45_0.12_230/0.05)] via-background to-[oklch(0.72_0.17_55/0.05)]">
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          <div className="flex flex-col items-center gap-6">
            <img src={LOGO_STACKED} alt="Total Health" className="h-28 w-auto" />
            <div className="text-center">
              <h1 className="text-2xl font-bold tracking-tight text-primary">
                Running Assessment Platform
              </h1>
              <p className="text-sm text-muted-foreground mt-2 max-w-sm">
                Comprehensive biomechanical analysis and report automation. Powered by data, personalised by expertise.
              </p>
            </div>
          </div>
          <Button
            ...
            <div className="flex items-center gap-3 px-2 transition-all w-full">
              ...
              {!isCollapsed ? (
                <div className="flex items-center gap-2 min-w-0">
                  <img src={LOGO_HORIZONTAL} alt="Total Health" className="h-8 w-auto" />
                </div>
              ) : null}
            </div>
          </SidebarHeader>
          ...
          <div className="flex border-b h-14 items-center justify-between bg-background/95 px-2 backdrop-blur supports-[backdrop-filter]:backdrop-blur sticky top-0 z-40">
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-3">
                <img src={LOGO_HORIZONTAL} alt="Total Health" className="h-6 w-auto" />
